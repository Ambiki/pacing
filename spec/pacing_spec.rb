...
RSpec.describe Pacing::Pacer do
  ...
  describe 'Cue specs' do
    ...
    it "should correctly parse the pacing for patient 17" do
      ...
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>9, :used_visits=>3, :pace=>0, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>6, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 23" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>10, :used_visits=>2, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>6, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 50" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>4, :used_visits=>4, :pace=>1, :pace_indicator=>"🐇", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 72" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>9, :used_visits=>3, :pace=>0, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 135" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>34, :used_visits=>55, :pace=>17, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>38, :reset_date=>"04-06-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 166" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Language Therapy", :remaining_visits=>26, :used_visits=>4, :pace=>2, :pace_indicator=>"🐇", :pace_suggestion=>"once a day", :expected_visits_at_date=>2, :reset_date=>"09-27-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 174" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Language Therapy", :remaining_visits=>8, :used_visits=>4, :pace=>-2, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>6, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 290" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>4, :used_visits=>2, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 307" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Language Therapy", :remaining_visits=>11, :used_visits=>1, :pace=>-5, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>6, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 332" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>48, :used_visits=>60, :pace=>-2, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>62, :reset_date=>"03-24-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 418" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>19, :used_visits=>89, :pace=>19, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>74, :reset_date=>"02-25-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 480" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>6, :used_visits=>3, :pace=>0, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 542" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>3, :used_visits=>0, :pace=>-3, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 644" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Language Therapy", :remaining_visits=>34, :used_visits=>74, :pace=>69, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>5, :reset_date=>"11-01-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 752" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>9, :used_visits=>4, :pace=>-3, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>7, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 780" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>14, :used_visits=>2, :pace=>-6, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>8, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 795" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>10, :used_visits=>3, :pace=>-4, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>7, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 812" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>19, :used_visits=>89, :pace=>-12, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>101, :reset_date=>"11-09-2022"}, {:discipline=>"Occupational Therapy", :remaining_visits=>1, :used_visits=>31, :pace=>1, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>30, :reset_date=>"11-09-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 833" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>7, :used_visits=>2, :pace=>-3, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>5, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 892" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>61, :used_visits=>9, :pace=>-1, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>10, :reset_date=>"08-29-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 911" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>104, :used_visits=>4, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>5, :reset_date=>"09-29-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 951" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>105, :used_visits=>3, :pace=>-2, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>5, :reset_date=>"09-29-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 973" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>11, :used_visits=>2, :pace=>-5, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>7, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1048" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>8, :used_visits=>1, :pace=>-4, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>5, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1239" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>12, :used_visits=>1, :pace=>-6, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>7, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1287" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>13, :used_visits=>4, :pace=>-5, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>9, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1338" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>39, :used_visits=>69, :pace=>-15, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>84, :reset_date=>"01-05-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 1361" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>4, :used_visits=>1, :pace=>-2, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1566" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>4, :used_visits=>0, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>1, :reset_date=>"10-24-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1609" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>53, :used_visits=>27, :pace=>-7, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>34, :reset_date=>"05-16-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 1610" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>52, :used_visits=>28, :pace=>-8, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>36, :reset_date=>"05-05-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 1638" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>30, :used_visits=>78, :pace=>-22, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>100, :reset_date=>"11-11-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1656" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>16, :used_visits=>3, :pace=>-7, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>10, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 1693" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>68, :used_visits=>50, :pace=>-16, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>66, :reset_date=>"03-25-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 1902" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>93, :used_visits=>15, :pace=>0, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>15, :reset_date=>"08-29-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 2052" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>70, :used_visits=>38, :pace=>-18, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>56, :reset_date=>"04-11-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 2061" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>13, :used_visits=>0, :pace=>-7, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>7, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2129" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>103, :used_visits=>5, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>6, :reset_date=>"09-28-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 2185" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>104, :used_visits=>14, :pace=>1, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>13, :reset_date=>"09-07-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 2200" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>21, :used_visits=>87, :pace=>-18, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>105, :reset_date=>"10-26-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2221" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>101, :used_visits=>7, :pace=>0, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>7, :reset_date=>"09-22-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 2331" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>68, :used_visits=>2, :pace=>-2, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>4, :reset_date=>"09-28-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 2357" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>11, :used_visits=>97, :pace=>-5, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>102, :reset_date=>"11-04-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2376" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>54, :used_visits=>64, :pace=>-39, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>103, :reset_date=>"12-02-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2377" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>3, :used_visits=>2, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2499" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>3, :used_visits=>0, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>1, :reset_date=>"10-24-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2608" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>5, :used_visits=>0, :pace=>-3, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2667" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>83, :used_visits=>25, :pace=>-22, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>47, :reset_date=>"05-10-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 2729" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>4, :used_visits=>3, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>4, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2950" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Occupational Therapy", :remaining_visits=>4, :used_visits=>0, :pace=>-2, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>2, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2977" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>5, :used_visits=>4, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>5, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 2999" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>113, :used_visits=>5, :pace=>-1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>6, :reset_date=>"09-28-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 3022" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>52, :used_visits=>56, :pace=>-21, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>77, :reset_date=>"01-27-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 3302" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>90, :used_visits=>28, :pace=>-33, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>61, :reset_date=>"03-04-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 3333" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>8, :used_visits=>4, :pace=>1, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>3, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 3595" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>30, :used_visits=>0, :pace=>-26, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>26, :reset_date=>"12-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 4035" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>49, :used_visits=>59, :pace=>-42, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>101, :reset_date=>"11-09-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 4038" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>84, :used_visits=>24, :pace=>-77, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>101, :reset_date=>"11-09-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 4056" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>103, :used_visits=>15, :pace=>1, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>14, :reset_date=>"09-02-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 4108" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>8, :used_visits=>5, :pace=>-2, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>7, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 4150" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>79, :used_visits=>29, :pace=>-17, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>46, :reset_date=>"05-16-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 4163" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>13, :used_visits=>3, :pace=>-5, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>8, :reset_date=>"11-01-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 4170" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>18, :used_visits=>90, :pace=>-8, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>98, :reset_date=>"11-18-2022"}])
    end
    ...
    it "should correctly parse the pacing for patient 4180" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>96, :used_visits=>22, :pace=>-28, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>50, :reset_date=>"05-16-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 4292" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>78, :used_visits=>40, :pace=>-14, :pace_indicator=>"🐢", :pace_suggestion=>"once a day", :expected_visits_at_date=>54, :reset_date=>"05-04-2023"}])
    end
    ...
    it "should correctly parse the pacing for patient 4557" do
      ...
      non_business_days = []
      results = Pacing::Pacer.new(school_plan: school_plan, date: date, non_business_days: non_business_days).calculate
      expect(results).to match_array([{:discipline=>"Speech Therapy", :remaining_visits=>12, :used_visits=>43, :pace=>0, :pace_indicator=>"😁", :pace_suggestion=>"once a day", :expected_visits_at_date=>43, :reset_date=>"01-04-2023"}])
    end
  end
end